...
export function Home() {
  ...
  const { revokeAccess, user, isLoggingOut } = useAuth();
  ...
  async function loggingOut() {
    try {
      ...
      Alert.alert('Erro ao SignOut', 'Ocorreu um erro ao sair, tente novamente.');
    }
  }
    ...
    >
      <Header>
        <UserInfo>
          ...
          <UserInfoText style={{ fontFamily: theme.fonts.bold }}>{user.name}</UserInfoText>
        </UserInfo>

        {
          isLoggingOut ? (
            ...
            <SignOutButton onPress={loggingOut}>
